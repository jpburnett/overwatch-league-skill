		...
		'en' : {
			'translation' : {
				...
				'WELCOME_MSG' : 'Welcome to Overwatch League. You can ask me about Overwatch League games and standings. For example,\
				 you can ask when the next %s game is, or, who the top three teams are. You can also ask me what games are today, or,\
				 what yesterday\'s results were. I am also able to tell you the games that will be played tomorrow. For more help,\
				 say help.',

				'WELCOME_REPROMPT' : 'For match information say, when is the next %s game, or, for ranking information ask what are\
				 the league standings. For more help, say help.',

				'PERMISSIONS_WELCOME' : 'Welcome to Overwatch League.',
